async function getWeather() {
    try {
        ...
        let res = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${cityName}&appid=bc583ad0cfaaf54190459162d807fe92&units=metric`);
       let data = await res.json();

        let res2 = await fetch(`https://api.openweathermap.org/data/2.5/onecall?lat=${data.coord.lat}&lon=${data.coord.lon}&appid=bc583ad0cfaaf54190459162d807fe92&units=metric`)
...
function displayWeather(obj) {
    ...
    locationIcon.setAttribute("src","https://img.icons8.com/?id=13778&size=2x&color=000000");
    ...
    realFeel.textContent = "Feels like "+"     "+ Math.floor(obj.main.feels_like)+`°C`;
...
function sevenDayWeather(arr){
    ...
    sticker1.src = "https://img.icons8.com/?id=qA3w9Yp2vY7r&size=2x&color=000000";
